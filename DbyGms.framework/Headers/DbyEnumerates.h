...
typedef NS_ENUM(NSInteger, DbyGmsJoinChannelErrorCode) {
    DbyGmsJoinChannelErrorOk = 0,               //用户加入频道成功
...
typedef NS_ENUM(NSInteger, DbyGmsQueryPeersOnlineErrorCode) {
    DbyGmsQueryPeersOnlineErrorOk = 0,               //查询成功
    DbyGmsQueryPeersOnlineErrorFailure = 1,          //查询失败
    DbyGmsQueryPeersOnlineErrorInvalidArgument = 2,  //查询参数不合法
