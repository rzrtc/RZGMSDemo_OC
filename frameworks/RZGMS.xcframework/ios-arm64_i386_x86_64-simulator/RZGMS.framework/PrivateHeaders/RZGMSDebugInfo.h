...
@interface RZGMSTavernSocket : NSObject
/// web端服务器地址
...
@interface RZGMSLoginArguments : NSObject
/// 户login时传入的userId值
...
@interface RZGMSDebugInfo : NSObject

@property (nonatomic, copy, readonly) NSString *sdkVersion;
@property (nonatomic, strong, readonly) RZGMSTavernSocket *tavernSocket;
@property (nonatomic, strong, readonly) RZGMSLoginArguments *loginArguments;
